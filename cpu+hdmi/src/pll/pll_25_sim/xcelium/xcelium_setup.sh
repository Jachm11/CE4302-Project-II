...
# ACDS 22.1 922 linux 2023.10.28.00:22:47
...
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/home/jachm/intelFPGA_lite/22.1std/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  xmvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pll_25.vo"
fi
